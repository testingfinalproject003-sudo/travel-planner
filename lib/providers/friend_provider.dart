...
class FriendProvider extends ChangeNotifier {
  ...
  /// 🔥 Getter: Can create trip (min 1 friend needed)
  bool get canCreateTrip => _friends.length > 1;

  /// 🔥 Getter: Friend count
  int get friendCount => _friends.length;

  /// 🔥 Getter: Pending request count (for badge)
  ...
  /// 🔥 Init method (called from main.dart)
  ...
  Future<void> acceptFriendRequest(FriendRequestModel request) async {
    ...
    try {
      ...
      // 🔥 Auto-create private chat between both users
